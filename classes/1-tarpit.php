...
//private $DOCUMENT_ROOT=$_SERVER['DOCUMENT_ROOT'];
	...
	public function tarpit(){
		require $_SERVER['DOCUMENT_ROOT'] . '/php-labrea/includes/config.php'; 
	...
	$filename =  $_SERVER['DOCUMENT_ROOT'] . '/php-labrea/'.$this->settings['blacklistfile']; // scan to prevent duplicates
